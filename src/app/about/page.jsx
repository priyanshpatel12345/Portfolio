        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col justify-center gap-12">
            ...
            <span className="italic">
              Passionate about web development and always eager to innovate.
            </span>
            {/* BIOGRAPHY SVG */}
            <motion.svg
...
"
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3">
                  ...
                  {/* JOB desc */}
                  <div className="p-3 text-sm italic">
                    I collaborated with a team to develop an innovative web
                    application in a time-constrained environment.
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 test-sm font-semibold ">
                    2 - 3 March 2023
...
"
                >
                  ...
                  {/* JOB desc */}
                  <div className="p-3 text-sm italic">
                    Created a blog website showcasing various features and
                  ...
                  {/* JOB Company */}
                  {/* <div className="p-1 rounded bg-white w-fit font-semibold text-sm"></div> */}
                </div>
